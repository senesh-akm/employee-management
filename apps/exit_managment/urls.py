...
urlpatterns = [
    ...
    # path("final-settlement/", views.final_settlement_list, name="final_settlement_list"),
    # path("final-settlement/add/", views.add_final_settlement, name="add_final_settlement"),
